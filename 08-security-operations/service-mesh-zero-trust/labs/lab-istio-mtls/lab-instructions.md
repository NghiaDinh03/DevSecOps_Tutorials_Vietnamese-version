...
1. Mở file [peer-authentication.yaml](file:///e:/VSC/DevSecOps_Tutorials_Vietnamese-version/08-security-operations/service-mesh-zero-trust/labs/lab-istio-mtls/manifests/peer-authentication.yaml) trên trình soạn thảo.
