...
Quay trở lại thư mục bài lab trên máy của bạn (`03-cicd-automation/01-github-actions/labs/lab-github-actions-runner/`). Tạo một tệp tin cấu hình môi trường `.env` nằm cùng cấp với tệp `docker-compose.yml` để lưu trữ mã bảo mật:
