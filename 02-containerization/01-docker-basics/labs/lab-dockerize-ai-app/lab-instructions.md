...
Hãy kiểm tra file `.dockerignore` mẫu đã được chuẩn bị sẵn tại thư mục: `02-containerization/01-docker-basics/labs/lab-dockerize-ai-app/configs/.dockerignore`
...
Hãy cùng phân tích tệp cấu hình Dockerfile mẫu đạt chuẩn an ninh cao được đặt tại thư mục: `02-containerization/01-docker-basics/labs/lab-dockerize-ai-app/configs/Dockerfile.secure`
...
```powershell
docker build -f 02-containerization/01-docker-basics/labs/lab-dockerize-ai-app/configs/Dockerfile.secure -t devsecops-gemma-app ../gemma-chat
```
