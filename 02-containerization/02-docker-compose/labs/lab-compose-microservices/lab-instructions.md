...
Hãy chuyển tới thư mục của bài lab: `02-containerization/02-docker-compose/labs/lab-compose-microservices/` và mở file `docker-compose.yml` đã được chuẩn bị sẵn để xem thiết kế.
...
```bash
cd 02-containerization/02-docker-compose/labs/lab-compose-microservices/
```
